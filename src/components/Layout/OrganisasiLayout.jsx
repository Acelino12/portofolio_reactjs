...
const OrganisasiLayout = () => {
    ...
    return (
        <>
            ...
            <h1 className=" font-extrabold font-sans text-center text-2xl">Organisasi</h1>
                <div className="w-full h-fit mt-10">
                    <div className=" bg-white w-4/12 h-fit pb-2 ps-2 ms-28 mt-28 float-left rounded-xl shadow-lg border-solid border-2 border-slate-300" data-aos="fade-left">
                        ...
                        <p className="pt-2 text-xl font-bold text-slate-900 text-center">Sekretaris PH | Pramuka</p>
